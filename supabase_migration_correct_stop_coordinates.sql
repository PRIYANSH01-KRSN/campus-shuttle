...
FROM (VALUES
  ...
  ('a1000001-0000-0000-0000-000000000006'::uuid, 28.520000::double precision, 77.570000::double precision),
...
SET coordinates = CASE route_id
  WHEN 'route-gate1' THEN '[[28.533180530044106,77.57664699610052],[28.5225,77.5703],[28.5235,77.5706],[28.5248,77.5709],[28.5242,77.5731],[28.520000,77.570000],[28.533180530044106,77.57664699610052]]'::jsonb
  WHEN 'route-gate2' THEN '[[28.53076962815911,77.58093845170927],[28.5225,77.5703],[28.5235,77.5706],[28.5248,77.5709],[28.5242,77.5731],[28.5254,77.5753],[28.5261,77.5757],[28.5266,77.5763],[28.5269,77.5771],[28.5298,77.5791],[28.53076962815911,77.58093845170927]]'::jsonb
  ELSE coordinates
END
