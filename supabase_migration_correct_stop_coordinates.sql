...
FROM (VALUES
  ...
  ('a1000001-0000-0000-0000-000000000005'::uuid, 28.52558333333333::double precision, 77.57166666666667::double precision),
  ...
  ('a2000001-0000-0000-0000-000000000014'::uuid, 28.52558333333333::double precision, 77.57166666666667::double precision),
...
SET coordinates = CASE route_id
  WHEN 'route-gate1' THEN '[[28.533180530044106,77.57664699610052],[28.5225,77.5703],[28.5235,77.5706],[28.525575,77.571672],[28.52558333333333,77.57166666666667],[28.528177747494905,77.57449105362907],[28.533180530044106,77.57664699610052]]'::jsonb
  WHEN 'route-gate2' THEN '[[28.53076962815911,77.58093845170927],[28.5225,77.5703],[28.5235,77.5706],[28.525575,77.571672],[28.52558333333333,77.57166666666667],[28.528177747494905,77.57449105362907],[28.5261,77.5757],[28.5266,77.5763],[28.5269,77.5771],[28.5298,77.5791],[28.53076962815911,77.58093845170927]]'::jsonb
  ELSE coordinates
END
